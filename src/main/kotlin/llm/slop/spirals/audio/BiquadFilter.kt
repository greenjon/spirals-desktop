 ...
 * Used for separating audio into frequency bands (bass, mid, high).
 */
class BiquadFilter(
    val type: Type,
    ...
    /**
     * Recalculates the filter coefficients. Must be called after updating sampleRate, frequency, or Q.
     */
    ...
    /**
     * Resets the filter's state registers to zero.
     */
    fun reset() {
        z1 = 0f
        z2 = 0f
